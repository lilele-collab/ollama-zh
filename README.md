# ⚠️ 本项目已停更 — Ollama 汉化补丁 (Ollama 中文版)

> **本项目已于 2026-08-30 停止维护。**
>
> - 已发布的 Release（如 `zh-v0.33.2`）仍可正常下载使用
> - CI 定时构建已关闭，不再自动跟踪上游新版本
> - 如需汉化更新，请参考本仓库工具链自行适配
>
> 感谢所有使用过本项目的朋友！
...
到 [Releases](https://github.com/user/ollama-zh/releases) 下载 `ollama-zh-v0.33.2-win64.zip`。
...
- **过期备份自动处理**:若检测到备份版本与当前官方版不一致(官方更新过,还原会回退到旧版),脚本会提示是否用当前官方版刷新备份,输入 Y 或回车即刷新;`apply-patch.ps1 -Force` 跳过提示自动刷新。已安装汉化版时不会误把汉化版当官方版备份
